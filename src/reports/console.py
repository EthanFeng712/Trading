...
def print_report(strategy_name, strategy_report: BacktestResult, benchmark_report: BacktestResult) -> None:
    console = Console()
    ...
    console.print(table)
    console.print("年化超额收益率:", format_str(strategy_metrics.annualized_return - benchmark_metrics.annualized_return, 0, ",.2%"))
